...
All simulations use the baseline calibration from Table 1 of the main text unless otherwise noted. The complete replication package, including all code and data, is available at \url{https://github.com/brunosmaniotto/MABNK}.
...
Two-phase dynamics: initial dampening followed by persistence as credibility erodes.
